 ...
 * implements a
 * state machine in an object-oriented way. With the state pattern, a
 * state
 * machine is implemented by implementing each individual state as a
 * derived
 * class of the state pattern interface, and implementing state
 * transitions by
