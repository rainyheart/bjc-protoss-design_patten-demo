...
public class TestTeam extends AbstractTeam implements Team {

	private Responsibility responsibility = Responsibility.Testing;
	...
	public double cost(Project project) {
		...
		return 30 + ((project.getSize() - this.teamSize) * 2);
	}
